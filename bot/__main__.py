...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, shell, eval, torrent_search, delete, usage, speedtest, count, config, updates
...
/{BotCommands.UsageCommand}: Cek sisa2 kehidupan dyno
'''
...
botcmds = [
        ...
        (f'{BotCommands.UsageCommand}','Cek sisa2 kehidupan dyno'),
